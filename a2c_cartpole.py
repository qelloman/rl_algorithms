...
def update_parameters(transitions, actor, critic, optim_actor, optim_critic, i_step):
    ...
    critic_loss = F.smooth_l1_loss(critic(buf_state), target) 
    ...
    for i_episode in range(num_episode):
        ...
        while not done:
            ...
            if len(buf) == batch_size:
                update_parameters(buf.dump(), actor, critic, optim_actor, optim_critic, i_step)
                buf.clear() 
